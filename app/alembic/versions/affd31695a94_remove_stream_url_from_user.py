"""Remove stream_url from User

Revision ID: affd31695a94
Revises: 0a5d2f54a223
Create Date: 2025-04-26 15:04:30.805671
...
def downgrade() -> None:
    ...
    sa.Column('created_at', mysql.DATETIME(), nullable=True),
    sa.Column('updated_at', mysql.DATETIME(), nullable=True),
    sa.Column('encoding_profileDetails', mysql.INTEGER(display_width=11), autoincrement=False, nullable=False),
